defmodule Services.ProviderServiceTest do
  ...
  describe "providers_service" do
    ...
    test "get_providers_service!/2 returns the providers_service with given id" do
      ...
      assert ProviderService.get_providers_service!(scope, providers_service.id) ==
               providers_service

      assert_raise Ecto.NoResultsError, fn ->
        ProviderService.get_providers_service!(other_scope, providers_service.id)
      end
    end
    ...
    test "create_providers_service/2 with valid data creates a providers_service" do
      ...
      assert {:ok, %ProvidersService{} = providers_service} =
               ProviderService.create_providers_service(scope, valid_attrs)
    ...
    test "create_providers_service/2 with invalid data returns error changeset" do
      ...
      assert {:error, %Ecto.Changeset{}} =
               ProviderService.create_providers_service(scope, @invalid_attrs)
    end
    ...
    test "update_providers_service/3 with valid data updates the providers_service" do
      ...
      assert {:ok, %ProvidersService{} = providers_service} =
               ProviderService.update_providers_service(scope, providers_service, update_attrs)
    ...
    test "update_providers_service/3 with invalid data returns error changeset" do
      ...
      assert {:error, %Ecto.Changeset{}} =
               ProviderService.update_providers_service(scope, providers_service, @invalid_attrs)

      assert providers_service ==
               ProviderService.get_providers_service!(scope, providers_service.id)
    end
    ...
    test "delete_providers_service/2 deletes the providers_service" do
      ...
      assert {:ok, %ProvidersService{}} =
               ProviderService.delete_providers_service(scope, providers_service)
    ...
    test "delete_providers_service/2 with invalid scope raises" do
      ...
      assert_raise MatchError, fn ->
        ProviderService.delete_providers_service(other_scope, providers_service)
      end
    end
    ...
    test "change_providers_service/2 returns a providers_service changeset" do
      ...
      assert %Ecto.Changeset{} =
               ProviderService.change_providers_service(scope, providers_service)
    end
  end
end
