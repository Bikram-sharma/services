defmodule Services.NotificationsTest do
  ...
  describe "special_notifications" do
    ...
    test "get_special_notification!/2 returns the special_notification with given id" do
      ...
      assert Notifications.get_special_notification!(scope, special_notification.id) ==
               special_notification

      assert_raise Ecto.NoResultsError, fn ->
        Notifications.get_special_notification!(other_scope, special_notification.id)
      end
    end
    ...
    test "create_special_notification/2 with valid data creates a special_notification" do
      ...
      assert {:ok, %SpecialNotification{} = special_notification} =
               Notifications.create_special_notification(scope, valid_attrs)
    ...
    test "create_special_notification/2 with invalid data returns error changeset" do
      ...
      assert {:error, %Ecto.Changeset{}} =
               Notifications.create_special_notification(scope, @invalid_attrs)
    end
    ...
    test "update_special_notification/3 with valid data updates the special_notification" do
      ...
      update_attrs = %{
        ...
        archive: "some updated archive",
        description: "some updated description"
      }

      assert {:ok, %SpecialNotification{} = special_notification} =
               Notifications.update_special_notification(
                 scope,
                 special_notification,
                 update_attrs
               )
    ...
    test "update_special_notification/3 with invalid data returns error changeset" do
      ...
      assert special_notification ==
               Notifications.get_special_notification!(scope, special_notification.id)
    end
    ...
    test "delete_special_notification/2 deletes the special_notification" do
      ...
      assert {:ok, %SpecialNotification{}} =
               Notifications.delete_special_notification(scope, special_notification)
    ...
    test "delete_special_notification/2 with invalid scope raises" do
      ...
      assert_raise MatchError, fn ->
        Notifications.delete_special_notification(other_scope, special_notification)
      end
    end
    ...
    test "change_special_notification/2 returns a special_notification changeset" do
      ...
      assert %Ecto.Changeset{} =
               Notifications.change_special_notification(scope, special_notification)
    end
  end
