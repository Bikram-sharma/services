        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mb-4">Connecting customers with trusted service providers in your local community.</p>
            ...
            <div class="border-t border-gray-800 pt-8">
                <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                    <p class="text-sm text-gray-500">&copy; 2024 ServiceHub. All rights reserved.</p>
                    <div class="flex space-x-6">
                        <a href="#" class="text-sm text-gray-500">Privacy Policy</a>
                        <a href="#" class="text-sm text-gray-500">Terms of Service</a>
                        <a href="#" class="text-sm text-gray-500">Cookie Policy</a>
                    </div>
                </div>
            </div>
        </div>
