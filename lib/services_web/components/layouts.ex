defmodule ServicesWeb.Layouts do
  ...
  def nav_link_class(conn, path) do
        ...
        <div class="mx-auto px-2 sm:px-4 lg:px-6">
          <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden md:flex items-center justify-center space-x-8 w-[60vw]">
              ...
              <% end %>
              <%= case @conn.assigns.notification do%>
              ...
              <ul class="hidden md:flex items-center space-x-8">
                <%= if @current_scope do %>
                  ...
                  <div class="dropdown dropdown-bottom dropdown-center">
                    ...
                    <div
                      tabindex="0"
                      class="dropdown-content mt-3"
                    >
                      <.avatar current_scope={@current_scope} />
                    </div>
                  </div>
                <% else %>
                  <li>
                ...
                <%= if @current_scope do %>
                  ...
                  <li>
                    <.link
                      ...
                      class="text-gray-700 text-red-600 font-medium transition-colors"
                      method="delete"
                    >
                      Log out
                    </.link>
  ...
  def avatar(assigns) do
    ...
    <div class="bg-white dark:bg-gray-800 w-[20vw] border border-gray-200 rounded-lg shadow z-10">
      <div class="relative">
        <div class="relative">
          <img
            src="https://img.freepik.com/free-vector/background_53876-57973.jpg"
            alt=""
      ...
      <div class="mt-10 px-4 py-2">
        <ul class="flex flex-col">
            ...
            <div class="flex items-center space-x-2 py-2">
              ...
              <.link
                href={~p"/users/log-out"}
                class="text-red-500 font-medium transition-colors"
                method="delete"
              >
                Log out
              </.link>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <p class="text-sm text-gray-400 mb-4">
              Connecting customers with trusted service providers in your local community.
            </p>
